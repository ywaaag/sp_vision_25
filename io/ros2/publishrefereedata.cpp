...
PublishRefereeData::PublishRefereeData()
: Node("referee_publisher")
{
    rclcpp::QoS qos(rclcpp::KeepLast(1));
    qos.best_effort();

    game_status_pub_ = create_publisher<combat_rm_interfaces::msg::GameStatus>("referee/game_status", qos);
    game_robot_hp_pub_ = create_publisher<combat_rm_interfaces::msg::GameRobotHp>("referee/game_robot_hp", qos);
    event_data_pub_ = create_publisher<combat_rm_interfaces::msg::EventData>("referee/event_data", qos);
    robot_status_pub_ = create_publisher<combat_rm_interfaces::msg::RobotStatus>("referee/robot_status", qos);
    ...
    rfid_status_pub_ = create_publisher<combat_rm_interfaces::msg::RfidStatus>("referee/rfid_status", qos);
    ground_robot_position_pub_ = create_publisher<combat_rm_interfaces::msg::GroundRobotPosition>("referee/ground_robot_position", qos);
    sentry_info_pub_ = create_publisher<combat_rm_interfaces::msg::SentryInfo>("referee/sentry_info", qos);
...
void PublishRefereeData::publishGroundRobotPosition(const GroundRobotPositionPackage::data & pkg)
{
    ...
    ground_robot_position_msg_.infantry_3_position.x = pkg.standard_3_x;
    ground_robot_position_msg_.infantry_3_position.y = pkg.standard_3_y;
    ground_robot_position_msg_.infantry_4_position.x = pkg.standard_4_x;
    ground_robot_position_msg_.infantry_4_position.y = pkg.standard_4_y;
